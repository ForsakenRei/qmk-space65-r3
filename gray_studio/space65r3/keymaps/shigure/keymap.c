...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT(
        ...
        _______, _______, KC_WBAK, KC_BSPC, KC_WFWD, _______, _______, SERACH,  TSK_MGR, _______, _______, _______, _______,          _______, KC_MUTE,
        _______, _______, _______,                            KC_DEL,                             _______, CTL_APP,          _______, _______, _______),
    [2] = LAYOUT(
        _______, KC_1,    KC_2,    KC_3,    _______, _______, _______, _______, _______, _______, _______, _______, _______, SFT_DEL, SFT_DEL, KC_SLEP,
        ...
        _______, _______, KC_0,    _______, KC_CALC, _______, _______, _______, TSK_MGR, _______, _______, _______, _______,          KC_BSPC, _______,
        _______, GU_TOGG, _______,                            _______,                            _______, _______,          KC_WBAK, KC_F5,   KC_WFWD),
    [3] = LAYOUT(
        UG_TOGG, KC_MUTE, KC_VOLD, KC_VOLU, KC_MPRV, KC_MPLY, KC_MNXT, _______, _______, _______, _______, KC_F13,  KC_F14,  _______, _______, UG_SATU,
        _______,          _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, QK_BOOT, UG_SATD,
        _______,          _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, EE_CLR,           UG_HUEU,
        _______, _______, _______, _______, _______, _______, _______, _______, DC_MUTE, _______, _______, _______, QK_RBT,           _______, UG_HUED,
        _______, _______, _______,                            _______,                            TO(0),   _______,          UG_VALD, _______, UG_VALU),
};
