...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [3] = LAYOUT(
        _______, KC_MUTE, KC_VOLD, KC_VOLU, KC_MPRV, KC_MPLY, KC_MNXT, _______, _______, _______, _______, KC_F13,  KC_F14,  _______, _______, RGB_SAI,
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, DC_MUTE, _______, _______, _______, QK_RBT,           _______, RGB_HUD,
